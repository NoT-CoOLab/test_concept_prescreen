...
const CONFIG = {
  // Short lowercase id, no spaces — used in filenames. e.g. "london"
  siteId: "Test",

  // Human-readable name shown in the header. e.g. "London"
  siteName: "Test",
  ...
  //   regions: [{ code: "GB", population: "British", label: { en: "United Kingdom" } }]
  regions: [
